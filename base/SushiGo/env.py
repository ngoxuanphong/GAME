...
test2_An_270922, test2_Dat_130922, test2_Hieu_270922, test2_Khanh_270922, 
test2_Phong_130922, test2_An_200922, test2_Phong_130922, test2_Dat_130922, 
test2_Khanh_200922, test2_NhatAnh_200922, test2_Hieu_130922,
test2_Phong_130922, test2_Khanh_130922, test2_Dat_130922, 
test2_NhatAnh_130922, test2_An_130922, 
@njit()
...
def one_game_numba(p0, list_other, per_player, per0, per1, per2, per3, per4, per5, per6, per7, per8, per9, per10, per11, per12, per13, per14, per15):
    ...
    while env[100] <= 400:
        ...
        if list_other[idx] == -1:
            ...
            action = get_func(player_state, list_other[idx], per0, per1, per2, per3, per4, per5, per6, per7, per8, per9, per10, per11, per12, per13, per14, per15)
