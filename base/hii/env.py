...
def getAgentState(e_state):
    ...
    p_state[423:423+52][np.where(e_state[55+52:55+52+52]== pIdx)[0]] = 1
    p_state[423+52:423+52+52][np.where(e_state[55+52:55+52+52]== (e_state[52] +1)% 4)[0]] = 1
    p_state[423+52+52:423+52+52+52][np.where(e_state[55+52:55+52+52]== (e_state[52] +2)% 4 )[0]] = 1
    p_state[423+52+52+52:423+52+52+52+52][np.where(e_state[55+52:55+52+52]== (e_state[52] +3)% 4)[0]] = 1
    p_state[631] = 1*(int(checkEnded(e_state)) != -1)
    return p_state
...
count,per1 = numba_main_2(numbaRandomBot, 100000, perx, 0)
#print(per1[2][0])